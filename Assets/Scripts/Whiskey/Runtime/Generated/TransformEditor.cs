...
#if UNITY_EDITOR
/// <summary>
/// Custom editor for <see cref="TransformEvent"/>s
/// </summary>
...
public class TransformEventEditor : UnityEditor.Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        v = (Transform)UnityEditor.EditorGUILayout.ObjectField(v, typeof(Transform), allowSceneObjects: true);

        if (UnityEngine.GUILayout.Button("Raise"))
        {
            foreach (var tgt in targets)
            {
                var evt = (TransformEvent)tgt;
                evt.Trigger(v);
            }
        }
    }
